...
//Get JS is Ready
		boolean jsReady = (Boolean) jsExec.executeScript("return document.readyState").toString().equals("compete");
...
//Post Wait for statbility (Optional)
				sleep(20);
			} else {
